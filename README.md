⚠️ | PokéAssistant **v2.88.5** has been released. Contains `Help Command, new UI and SH Steal Warn`! [Learn More](https://github.com/TrashUwU/PokeAssistant#extra-features). Your code will be updated automatically.
:--- | :---
